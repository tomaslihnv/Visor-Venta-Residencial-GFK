...
const STORAGE_KEY = 'visor_mp_sc_v1';
...
function _syncTipologias() {
  mp.tipologias = [{
    ...
    sup:    mp.gla,
    ufm2:   mp.ufm2,
    renta:  mp.ufm2 != null && mp.gla != null ? mp.ufm2 * mp.gla : null,
  }];
}
...
// StripCenters es un visor "flat" (una sola métrica por proyecto, no tarjetas
// de tipología). Exportamos/importamos igual mp.tipologias (síntesis
