...
const STORAGE_KEY = 'visor_mp_pi_v1';
...
function _syncTipologias() {
  mp.tipologias = [{
    ...
    sup:    mp.sup,
    ufm2:   mp.ufm2,
    renta:  mp.ufm2 != null && mp.sup != null ? mp.ufm2 * mp.sup : null,
  }];
}
...
// ParquesIndustriales es un visor "flat" (una sola métrica por proyecto, no
// tarjetas de tipología). Exportamos/importamos igual mp.tipologias (síntesis
// automática vía _syncTipologias) para reusar el mismo formato de archivo.
